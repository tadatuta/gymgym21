...
Workflow добавлен в T02; первый запуск на GitHub проверяется после push (локальные проверки не подтверждают работу hosted runner). Покрытие настоящего repository и миграций сверено в T03: [матрица PostgreSQL](../audit/postgres-tests.md). Дальнейшее усиление покрытия T04–T06 ещё не завершено. Дополнительные audit-сценарии описаны в [каталоге проверок](../audit/README.md). Конфигурация сверена с [официальным setup-node](https://github.com/actions/setup-node), [checkout](https://github.com/actions/checkout) и [документацией PostgreSQL services](https://docs.github.com/en/actions/tutorials/use-containerized-services/create-postgresql-service-containers).
